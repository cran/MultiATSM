...
- **ForType**:  rolling window forecasting to be done by setting this parameter as *Rolling*. In such a case, the forecast length used in the forecasts is the one specified as in *t0Sample*. Should the user wishes the forecasts to be performed on a expanding window basis, then this input should be left empty.
