#'@title Data: Risk Factors for the GVAR - Candelon and Moura (forthcoming, JFEC)
#'
#' @description Risk factors data used in the GVAR models - Candelon and Moura (forthcoming, JFEC)
#' @name FactorsGVAR
#' @docType data
